...
//import GeodesicManager  from "../GeodesicManager.js";
...
API.init = (app)=>{
    ...
    console.log("GEODESIC ADDON:", geodesic);
...
*/
       //  const GEODESIC = new GeodesicManager(
       // path.resolve(Core.DIR_TOOLS, "geodesic_server/geodesic_thoth_server_multimesh.exe")
   // );
    });
